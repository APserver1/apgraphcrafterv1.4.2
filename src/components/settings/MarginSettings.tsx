...
export const MarginSettings: React.FC<MarginSettingsProps> = ({
  ...
  const marginInputs = [
    { label: 'Margen arriba', key: 'top', max: 500 },
    { label: 'Margen abajo', key: 'bottom', max: 1000 },
    { label: 'Margen izquierdo', key: 'left', max: 1000 },
    { label: 'Margen derecho', key: 'right', max: 1000 },
  ] as const;
